/*
   ...
   limitations under the License.
	...
	FILE NAME: AutoWho_trgINS_AutoWhoOptions.sql

	TRIGGER NAME: AutoWho_trgINS_AutoWhoOptions
...
GO
CREATE TRIGGER @@CHIRHO_SCHEMA@@.AutoWho_trgINS_AutoWhoOptions ON @@CHIRHO_SCHEMA@@.AutoWho_Options
