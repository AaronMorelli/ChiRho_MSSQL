...
GO
CREATE PROCEDURE @@CHIRHO_SCHEMA@@.AutoWho.MaintainIndexes
/*
	...
	*/
	...
	BEGIN
		...
		BEGIN TRY
			...
			EXEC @@CHIRHO_SCHEMA@@.AutoWho_LogEvent @ProcID=@@PROCID, @EventCode=0, @TraceID=NULL, @Location='After dynamic index rebuild', @Message=@LogMessage;
		END TRY
		BEGIN CATCH
			...
			EXEC @@CHIRHO_SCHEMA@@.AutoWho_LogEvent @ProcID=@@PROCID, @EventCode=0, @TraceID=NULL, @Location='CATCH dynamic index rebuild', @Message=@LogMessage;
		END CATCH
