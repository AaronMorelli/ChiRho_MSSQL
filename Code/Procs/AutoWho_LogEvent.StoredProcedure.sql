...
GO
CREATE PROCEDURE @@CHIRHO_SCHEMA@@.AutoWho_LogEvent
/*   
...
To Execute
------------------------
EXEC @@CHIRHO_SCHEMA@@.AutoWho_LogEvent @ProcID=@@PROCID, @EventCode=0, @TraceID=NULL, @Location='text that identifies the statement we just captured a rowcount for', @Message='The details of what is to be logged.';
*/
(
	@ProcID			INT,
