...
GO
CREATE PROCEDURE @@CHIRHO_SCHEMA@@.AutoWho_ResetOptions
/*   
	...
	PURPOSE: Deletes the row in @@CHIRHO_SCHEMA@@.AutoWho_Options and re-inserts a row based on default values
...
SELECT * FROM @@CHIRHO_SCHEMA@@.AutoWho_Options
*/
AS
BEGIN
	SET NOCOUNT ON;

	INSERT INTO @@CHIRHO_SCHEMA@@.AutoWho_Options_History
	(
	...
	'Reset',
	SUSER_NAME()
	FROM @@CHIRHO_SCHEMA@@.AutoWho_Options;

	DISABLE TRIGGER AutoWho_trgDEL_AutoWhoOptions ON @@CHIRHO_SCHEMA@@.AutoWho_Options;

	DELETE FROM @@CHIRHO_SCHEMA@@.AutoWho_Options;

	ENABLE TRIGGER AutoWho_trgDEL_AutoWhoOptions ON @@CHIRCHO_SCHEMA@@.AutoWho_Options;

	INSERT INTO @@CHIRHO_SCHEMA@@.AutoWho_Options 
		DEFAULT VALUES;
