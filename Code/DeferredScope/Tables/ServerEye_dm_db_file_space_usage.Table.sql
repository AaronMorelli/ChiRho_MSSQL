/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye_dm_db_file_space_usage.Table.sql

	TABLE NAME: ServerEye_dm_db_file_space_usage
...
SET ANSI_PADDING ON
GO
CREATE TABLE @@CHIRHO_SCHEMA@@.ServerEye_dm_db_file_space_usage(
