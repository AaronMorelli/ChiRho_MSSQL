/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye_DimSpinlock.Table.sql

	TABLE NAME: ServerEye_DimSpinlock
...
SET ANSI_PADDING ON
GO
CREATE TABLE @@CHIRHO_SCHEMA@@.ServerEye_DimSpinlock(
...
SET ANSI_PADDING ON
GO
CREATE UNIQUE NONCLUSTERED INDEX [AK_SpinlockName] ON @@CHIRHO_SCHEMA@@.ServerEye_DimSpinlock
(
	[SpinlockName] ASC
)
INCLUDE ( 	
