/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye_DimRBSecurityError.Table.sql

	TABLE NAME: ServerEye_DimRBSecurityError
...
SET ANSI_PADDING ON
GO
CREATE TABLE @@CHIRHO_SCHEMA@@.ServerEye_DimRBSecurityError(
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [AKDimRBSecurityError] ON @@CHIRHO_SCHEMA@@.ServerEye_DimRBSecurityError(
	[APIName],
	[CallingAPIName],
	[ErrorCode],
	[SQLErrorCode]
