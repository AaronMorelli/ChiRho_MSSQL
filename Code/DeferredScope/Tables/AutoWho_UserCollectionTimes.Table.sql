/*
   ...
   limitations under the License.
	...
	PURPOSE: Holds the most recent set of capture times from user-initiated calls to @@CHIRHO_SCHEMA@@.AutoWho_Collector.
*/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE @@CHIRHO_SCHEMA@@.AutoWho_UserCollectionTimes(
