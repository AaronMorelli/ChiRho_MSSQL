/*
   ...
   limitations under the License.
	...
	characteristics match the code specified by @@CHIRHO_SCHEMA@@.AutoWho_ObtainSessionsForThresholdIgnore
*/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE @@CHIRHO_SCHEMA@@.AutoWho_ThresholdFilterSpids(
