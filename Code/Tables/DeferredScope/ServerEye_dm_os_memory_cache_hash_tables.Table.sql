/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye_dm_os_memory_cache_hash_tables.Table.sql

	TABLE NAME: ServerEye_dm_os_memory_cache_hash_tables
...
SET ANSI_PADDING ON
GO
CREATE TABLE @@CHIRHO_SCHEMA@@.ServerEye_dm_os_memory_cache_hash_tables(
