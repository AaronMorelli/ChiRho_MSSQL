/*
   ...
   limitations under the License.
	...
	of fields from sys.dm_exec_sessions) observed by @@CHIRHO_SCHEMA@@.AutoWho_Collector
*/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE @@CHIRHO_SCHEMA@@.AutoWho_DimSessionAttribute(
...
SET ANSI_PADDING ON
GO
CREATE UNIQUE NONCLUSTERED INDEX [AK_AutoWho_DimSessionAttribute] ON @@CHIRHO_SCHEMA@@.AutoWho_DimSessionAttribute
(
	[host_name] ASC,
	[program_name] ASC,
	[client_version] ASC,
...
GO
ALTER TABLE @@CHIRHO_SCHEMA@@.AutoWho_DimSessionAttribute ADD  CONSTRAINT [DF_AutoWho_DimSessionAttributes_TimeAdded]  DEFAULT (GETDATE()) FOR [TimeAdded]
GO
ALTER TABLE @@CHIRHO_SCHEMA@@.AutoWho_DimSessionAttribute ADD  CONSTRAINT [DF_AutoWho_DimSessionAttributes_TimeAddedUTC]  DEFAULT (GETUTCDATE()) FOR [TimeAddedUTC]
GO